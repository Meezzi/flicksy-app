...
void main() {
  group('MovieResponseDto', () {
    test('fromJson 테스트', () {
      final dto = MovieDto.fromJson(movieResponseJson);
  ...
  group('MovieDetailDto', () {
    test('fromJson 테스트', () {
      final dto = MovieDetailDto.fromJson(movieDetailDtoJson);

      expect(dto.id, 10754);
      expect(dto.title, '살인에 관한 짧은 필름');
    });
